...
def get_my_ip_address():
    result = client.service.MyIPAddress()
    get_my_ip_address_result_label.config(text = 'Result: ' + result)
...
is_username_free_result_label = Label(frame, text = 'Result')
